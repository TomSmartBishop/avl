...
TEST_CASE( "2 | Helper functions", "[vec2<float>(2)]" )
{
...
TEST_CASE( "2 | Getters and setters for all vectors", "[vec2<float>(2)]" )
{
...
TEST_CASE( "2 | Vector length operations", "[vec2<float>(2)]" )
{
...
TEST_CASE( "2 | Spacial operations", "[vec2<float>(2)]" )
{
...
TEST_CASE( "2 | Getter and setters for 2 component vectors", "[vec2<float>(2)]" )
{
...
TEST_CASE( "2 | General vector operations for 2 component vectors", "[vec2<float>(2)]" )
{
...
TEST_CASE( "2 | General purpos functions for 2 component vectors", "[vec2<float>(2)]" )
{
