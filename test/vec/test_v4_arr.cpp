...
TEST_CASE( "Setters and getters for float(4)", "[float(4)]" ) {
	float var[4];
...
TEST_CASE( "Add operation for float(4)", "[float(4)]" ) {
	float var_1[4] = { 0.9f , 1.8f , 2.7f , 3.6f  };
	float var_2[4] = { 9.0f , 8.1f , 7.2f , 6.3f  };
...
TEST_CASE( "Sub operation for float(4)", "[float(4)]" ) {
	float var_1[4] = { 0.9f , 1.8f , 2.7f , 3.6f  };
	float var_2[4] = { 9.0f , 8.1f , 7.2f , 6.3f  };
	//let the compiler evaluate the result
	const float expt_res_1[4] = { 0.9f - 9.0f , 1.8f - 8.1f , 2.7f - 7.2f , 3.6f - 6.3f  };
...
TEST_CASE( "Mul operation for float(4)", "[float(4)]" ) {
	float var_1[4] = { 0.9f , 1.8f , 2.7f , 3.6f  };
	float var_2[4] = { 9.0f , 8.1f , 7.2f , 6.3f  };
	//let the compiler evaluate the result
	const float expt_res_1[4] = { 0.9f * 9.0f , 1.8f * 8.1f , 2.7f * 7.2f , 3.6f * 6.3f  };
...
TEST_CASE( "Div operation for float(4)", "[float(4)]" ) {
	float var_1[4] = { 0.9f , 1.8f , 2.7f , 3.6f  };
	float var_2[4] = { 9.0f , 8.1f , 7.2f , 6.3f  };
	//let the compiler evaluate the result
	const float expt_res_1[4] = { 0.9f / 9.0f , 1.8f / 8.1f , 2.7f / 7.2f , 3.6f / 6.3f  };
...
TEST_CASE( "Length operations for float(4)", "[float(4)]" ) {
	float var[4] = { 0.9f , 1.8f , 2.7f , 3.6f  };
