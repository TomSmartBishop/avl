...
TEST_CASE( "Spacial operations", "[vec3<float>(3)]" )
{
	...
	{
		const float random_len1 = { 30.752 };
		const float random_len2 = { 44.111 };
		const float random_len3 = { 87.757 };
		const float random_len4 = { 31.643 };
