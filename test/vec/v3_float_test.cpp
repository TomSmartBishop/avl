...
TEST_CASE( "Vector length operations/3", "[vec3<float>(3)]" )
{
	SECTION( "Returns a new vector with the requested length/1" )
	{
		...
		{
			const vec3<float> vec = { 89.966, 0.972, 79.548 };
		...
		{
			const vec3<float> vec = { 84.250, 80.794, 15.910 };
	...
	{
		{
			vec3<float> vec = { 42.835, 91.443, -80.435 };
			const float len_to_set = { 49.484 };
		...
		{
			vec3<float> vec = { -66.180, -81.802, -22.158 };
			const float len_to_set = { 9.729 };
			setlen_set(vec, len_to_set);
			const auto vec_len = len<2>(vec);
		...
		{
			vec3<float> vec = { 77.540, 8.166, 77.828 };
			const float len_to_set = { 17.454 };
			setlen_set(vec, len_to_set);
	...
	SECTION( "Set the length of the vector and return the same vector (chained)/1" )
	{
		...
		{
			vec3<float> vec = { -14.506, -64.685, -97.796 };
		...
		{
			vec3<float> vec = { -76.174, -87.059, 91.527 };
			const float len_to_set = { 46.72 };
			const auto &ret_vec = setlen(vec, len_to_set);
			const auto vec_len = len<3>(vec);
	...
	{
		{
			const vec3<float> vec = { -39.516, 5.022, -55.346 };
			const auto vec_len = len<-2>(vec);
		...
		{
			const vec3<float> vec = { 64.931, -71.991, 18.044 };
			const auto vec_len = len<2>(vec);
		...
		{
			const vec3<float> vec = { 30.556, -30.752, 44.111 };
			const auto vec_len = len<3>(vec);
	...
	{
		{
			const vec3<float> vec = { -87.757, 31.643, -20.870 };
		...
		{
			const vec3<float> vec = { 99.803, 15.063, 91.631 };
			const auto vec_len_sqr = len_sqr<2>(vec);
		...
		{
			const vec3<float> vec = { 95.936, 79.751, 32.164 };
	...
	{
		const vec3<float> vec = { -98.242, -47.634, 11.530 };
		const auto new_norm_vec = norm_mk<-2>(vec);
		const auto norm_len = len<-2>(new_norm_vec);
		REQUIRE( norm_len == Approx( cnst<float>::one ) );
		const vec3<float> vec = { -23.339, -20.869, -42.571 };
		const auto new_norm_vec = norm_mk<2>(vec);
		const auto norm_len = len<2>(new_norm_vec);
		REQUIRE( norm_len == Approx( cnst<float>::one ) );
		const vec3<float> vec = { -66.230, 96.213, 63.923 };
	...
	{
		vec3<float> vec = { -29.223, 83.438, -89.235 };
		norm_set<-2>(vec);
		const auto len_of_norm_vec = len<-2>(vec);
		REQUIRE( len_of_norm_vec == Approx( cnst<float>::one ) );
		vec3<float> vec = { 64.109, -5.500, -59.844 };
		norm_set<2>(vec);
		const auto len_of_norm_vec = len<2>(vec);
		REQUIRE( len_of_norm_vec == Approx( cnst<float>::one ) );
		vec3<float> vec = { -71.993, 35.807, 23.679 };
		norm_set<3>(vec);
	...
	{
		vec3<float> vec = { -44.516, -17.864, -55.271 };
		const auto &ret_vec = norm<-2>(vec);
		const auto len_of_norm_vec = len<-2>(vec);
		REQUIRE( len_of_norm_vec == Approx( cnst<float>::one ) );
		REQUIRE( &vec == &ret_vec);
		vec3<float> vec = { 54.458, 53.365, -77.151 };
		const auto &ret_vec = norm<2>(vec);
		const auto len_of_norm_vec = len<2>(vec);
		REQUIRE( len_of_norm_vec == Approx( cnst<float>::one ) );
		REQUIRE( &vec == &ret_vec);
		vec3<float> vec = { 9.297, 68.259, 31.885 };
...
TEST_CASE( "Spacial operations/3", "[vec3<float>(3)]" )
{
	...
	{
		const float random_len1 = { 1.285 };
		const float random_len2 = { 91.23 };
		const float random_len3 = { 7.666 };
		const float random_len4 = { 64.986 };
	...
	{
		const float random_len1 = { 43.384 };
		const float random_len2 = { 74.225 };
		const float random_len3 = { 27.629 };
		const float random_len4 = { 69.916 };
	...
	{
		const float random_len1 = { 65.982 };
		const float random_len2 = { 12.719 };
		const float random_len3 = { 13.388 };
		const float random_len4 = { 8.611 };
	...
	{
		const float random_len1 = { 44.171 };
		const float random_len2 = { 17.159 };
		const float random_len3 = { 30.164 };
		const float random_len4 = { 58.525 };
...
TEST_CASE( "Getter and setters for 3 component vectors/3", "[vec3<float>(3)]" )
{
	...
	SECTION( "Set all vector components individually/1" )
	{
		{
			vec3<float> vec = { 0, 0, 0 };
			const float arr [] = { -89.937, 83.113, 76.661 };
			
			set_all<-2>(vec,arr[0], arr[1], arr[2]);
		...
		{
			vec3<float> vec = { 0, 0, 0 };
			const float arr [] = { 54.562, 89.966, 0.972 };
		...
		{
			vec3<float> vec = { 0, 0, 0 };
			const float arr [] = { 79.548, 60.731, 84.250 };
			
			set_all<3>(vec,arr[0], arr[1], arr[2]);
	...
	SECTION( "Set all vector components individually by a fixed size array/1" )
	{
		{
			vec3<float> vec = { 0, 0, 0 };
			const float arr [] = { 80.794, 15.910, -56.508 };
		...
		{
			vec3<float> vec = { 0, 0, 0 };
			const float arr [] = { 42.835, 91.443, -80.435 };
		...
		{
			vec3<float> vec = { 0, 0, 0 };
			const float arr [] = { 49.484, -66.180, -81.802 };
...
{
	vec3<float> add_var_1 = { -22.158, -9.729, 77.540 };
	vec3<float> add_var_2 = { 8.166, 77.828, -17.454 };
	const float add_scalar = { 86.022 };
	...
	vec3<float> sub_var_1 = { 2.399, -83.996, 5.982 };
	vec3<float> sub_var_2 = { -14.506, -64.685, -97.796 };
	const float sub_scalar = { -83.889 };
	...
	vec3<float> mul_var_1 = { -76.174, -87.059, 91.527 };
	vec3<float> mul_var_2 = { 46.720, -39.516, 5.022 };
	const float mul_scalar = { -55.346 };
	...
	vec3<float> div_var_1 = { 64.931, -71.991, 18.044 };
	vec3<float> div_var_2 = { 30.556, -30.752, 44.111 };
	const float div_scalar = { -87.757 };
...
TEST_CASE( "General purpos functions for 3 component vectors/3", "[vec3<float>(3)]" )
{
	SECTION( "Dot product/1" )
	{
...

		{
			...
			const vec3<float> test_vec1 = { 31.643, -20.870, 99.803 };
			const vec3<float> test_vec2 = {-get<0>(test_vec1), -get<1>(test_vec1), -get<2>(test_vec1)};
			const vec3<float> perpendicular1 = { get<idx[1]>(test_vec1)*signs1[0], get<idx[2]>(test_vec1)*signs1[0] };
			const vec3<float> perpendicular2 = { get<idx[1]>(test_vec1)*signs2[0], get<idx[2]>(test_vec1)*signs2[0] };
			...
			REQUIRE( dot_prod_perp1 == Approx( get<1>(test_vec1) * get<1>(perpendicular1) + get<2>(test_vec1) * get<2>(perpendicular1) ) );
			const auto dot_prod_perp2 = dot<-2>(test_vec1, perpendicular2);
			REQUIRE( dot_prod_perp2 == Approx( get<1>(test_vec1) * get<1>(perpendicular2) + get<2>(test_vec1) * get<2>(perpendicular2) ) );
		}
		{

			const vec3<float> test_vec1 = { 15.063, 91.631, 95.936 };
			const vec3<float> test_vec2 = {-get<0>(test_vec1), -get<1>(test_vec1), -get<2>(test_vec1)};
			const vec3<float> perpendicular1 = { get<idx[0]>(test_vec1)*signs1[4], get<idx[1]>(test_vec1)*signs1[4] };
			const vec3<float> perpendicular2 = { get<idx[0]>(test_vec1)*signs2[4], get<idx[1]>(test_vec1)*signs2[4] };
			const auto test_vec1_len = len(test_vec1);
			const auto test_vec2_len = len(test_vec2);
		...
		}
		{
			...
			const vec3<float> test_vec1 = { 79.751, 32.164, -98.242 };
			const vec3<float> test_vec2 = {-get<0>(test_vec1), -get<1>(test_vec1), -get<2>(test_vec1)};
			const vec3<float> perpendicular1 = { get<idx[0]>(test_vec1)*signs1[5], get<idx[1]>(test_vec1)*signs1[5], get<idx[2]>(test_vec1)*signs1[5] };
			const vec3<float> perpendicular2 = { get<idx[0]>(test_vec1)*signs2[5], get<idx[1]>(test_vec1)*signs2[5], get<idx[2]>(test_vec1)*signs2[5] };
			const auto test_vec1_len = len(test_vec1);
			const auto test_vec2_len = len(test_vec2);
