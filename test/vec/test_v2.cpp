...
TEST_CASE( "Setters and getters for vec2<float>(2)", "[vec2<float>(2)]" ) {
	vec2<float> var;
...
TEST_CASE( "Add operation for vec2<float>(2)", "[vec2<float>(2)]" ) {
	vec2<float> var_1 = { 0.9f , 1.8f  };
	vec2<float> var_2 = { 9.0f , 8.1f  };
...
TEST_CASE( "Sub operation for vec2<float>(2)", "[vec2<float>(2)]" ) {
	vec2<float> var_1 = { 0.9f , 1.8f  };
	vec2<float> var_2 = { 9.0f , 8.1f  };
	//let the compiler evaluate the result
	const float expt_res_1[2] = { 0.9f - 9.0f , 1.8f - 8.1f  };
...
TEST_CASE( "Mul operation for vec2<float>(2)", "[vec2<float>(2)]" ) {
	vec2<float> var_1 = { 0.9f , 1.8f  };
	vec2<float> var_2 = { 9.0f , 8.1f  };
	//let the compiler evaluate the result
	const float expt_res_1[2] = { 0.9f * 9.0f , 1.8f * 8.1f  };
...
TEST_CASE( "Div operation for vec2<float>(2)", "[vec2<float>(2)]" ) {
	vec2<float> var_1 = { 0.9f , 1.8f  };
	vec2<float> var_2 = { 9.0f , 8.1f  };
	//let the compiler evaluate the result
	const float expt_res_1[2] = { 0.9f / 9.0f , 1.8f / 8.1f  };
...
TEST_CASE( "Length operations for vec2<float>(2)", "[vec2<float>(2)]" ) {
	vec2<float> var = { 0.9f , 1.8f  };
