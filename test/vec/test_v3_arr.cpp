...
TEST_CASE( "Setters and getters for float(3)", "[float(3)]" ) {
	float var[3];
...
TEST_CASE( "Add operation for float(3)", "[float(3)]" ) {
	float var_1[3] = { 0.9f , 1.8f , 2.7f  };
	float var_2[3] = { 9.0f , 8.1f , 7.2f  };
...
TEST_CASE( "Sub operation for float(3)", "[float(3)]" ) {
	float var_1[3] = { 0.9f , 1.8f , 2.7f  };
	float var_2[3] = { 9.0f , 8.1f , 7.2f  };
	//let the compiler evaluate the result
	const float expt_res_1[3] = { 0.9f - 9.0f , 1.8f - 8.1f , 2.7f - 7.2f  };
...
TEST_CASE( "Mul operation for float(3)", "[float(3)]" ) {
	float var_1[3] = { 0.9f , 1.8f , 2.7f  };
	float var_2[3] = { 9.0f , 8.1f , 7.2f  };
	//let the compiler evaluate the result
	const float expt_res_1[3] = { 0.9f * 9.0f , 1.8f * 8.1f , 2.7f * 7.2f  };
...
TEST_CASE( "Div operation for float(3)", "[float(3)]" ) {
	float var_1[3] = { 0.9f , 1.8f , 2.7f  };
	float var_2[3] = { 9.0f , 8.1f , 7.2f  };
	//let the compiler evaluate the result
	const float expt_res_1[3] = { 0.9f / 9.0f , 1.8f / 8.1f , 2.7f / 7.2f  };
...
TEST_CASE( "Length operations for float(3)", "[float(3)]" ) {
	float var[3] = { 0.9f , 1.8f , 2.7f  };
