...
namespace avl {
	...
	avl_ainl_res constexpr auto div_mk(const v3& vec, const v3& other) noexcept {
	...
	avl_ainl_res constexpr auto div_mk(const v3& vec, const sc scalar) noexcept {
	...
	avl_ainl_res constexpr auto area(v3 vec, const v3& other) noexcept -> decltype(cmp(vec)) {
	...
	avl_ainl_res constexpr auto dot(const v3& vec, const v3& other) noexcept -> decltype(cmp(vec)) {
